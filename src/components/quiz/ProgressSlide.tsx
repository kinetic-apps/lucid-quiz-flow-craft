    ...
    <AnimatePresence>
      {visible && (
        ...
        >
          ...
          <h4 className="font-semibold text-[#BC5867]">{name}</h4>
        ...
        >
          ...
          >
            ...
            <div className="flex justify-center space-x-4">
              ...
              <Button
                className="flex-1 bg-[#BC5867] hover:bg-[#a34857] text-white rounded-full"
  ...
  return (
    <div className="mb-8">
      ...
      <div className="flex justify-between mb-1">
        ...
        <span className="text-sm font-semibold text-[#BC5867]">{progress}%</span>
      </div>
      <div className="w-full bg-gray-200 rounded-full h-4 overflow-hidden">
        <motion.div
          className="h-full bg-[#BC5867] rounded-full"
          initial={{ width: "0%" }}
          animate={controls}
        />
      </div>
